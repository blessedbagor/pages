  ...
  return (
    <ul className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
      <GridItem
        ...
        link="https://care.igift.com.ph/wp-admin/admin.php?page=dashboard#/"
      />
      <GridItem
        area="md:[grid-area:auto] xl:[grid-area:auto]"
        ...
        buttonText="Login to Community"
        link="https://connect.igift.com.ph/community/?fcom_action=auth"
      />
      <GridItem
        area="md:[grid-area:auto] xl:[grid-area:auto]"
      ...
      <GridItem
        ...
        title="iGift Super Dashboard"
        description="Explore our new Super Dashboard Platform for a comprehensive view of your iGift experience."
        buttonText="Login as Beta Tester"
        link="https://platform.igift.ph"
      />
    </ul>
  );
}
