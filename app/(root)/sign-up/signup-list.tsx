  ...
  return (
    <ul className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
      ...
      <GridItem
        ...
        link="https://connect.igift.com.ph/community?fcom_action=auth&form=register"
      />
      <GridItem
        area="md:[grid-area:auto] xl:[grid-area:auto]"
        ...
        buttonText="You need to be invited to access this platform"
        link="#"
      />
      <GridItem
        area="md:[grid-area:auto] xl:[grid-area:auto]"
        ...
        buttonText="Sign Up as Beta Tester"
        link="https://platform.igift.ph/sign-up"
      />
    </ul>
  );
}
